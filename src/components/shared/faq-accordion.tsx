...
function FAQAccordionItem({ item, index, isExpanded, onToggle }: FAQAccordionItemProps) {
      ...
      >
        ...
        <motion.span
          className={cn(
            ...
            isExpanded ? "text-bg-brand-solid" : "text-fg-tertiary group-hover:text-bg-brand-solid"
          )}
        ...
        {/* Question text with glitch on hover */}
        <span
          className={cn(
            "flex-1 font-medium text-base md:text-lg",
            "transition-colors duration-200 glitch-on-hover",
            isExpanded ? "text-bg-brand-solid" : "text-fg-primary group-hover:text-bg-brand-solid"
          )}
