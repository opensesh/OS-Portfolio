...
import { FeaturedIcon as FeaturedIconbase } from "@/components/uui/foundations/featured-icon/featured-icon";
import type { BackgroundPatternProps } from "@/components/uui/shared-assets/background-patterns";
import { BackgroundPattern } from "@/components/uui/shared-assets/background-patterns";
import { Illustration as Illustrations } from "@/components/uui/shared-assets/illustrations";
...
const rowStyles = {
    sm: ["size-8 rounded-none", "size-9 rounded-[7px]", "size-10 rounded-none", "size-11 rounded-[9px]"],
    md: ["size-10 rounded-none", "size-11 rounded-[9px]", "size-12 rounded-[10px]"],
    lg: ["size-10 rounded-none", "size-11 rounded-[9px]", "size-12 rounded-[10px]"],
} as const;
...
const gridStyles = {
    sm: { avatar: "size-8 rounded-none", inner: "rounded-[5px]", gap: "gap-2 pl-2", rowGap: "gap-2" },
    md: { avatar: "size-10 rounded-none", inner: "rounded-[7px]", gap: "gap-3 pl-3", rowGap: "gap-3" },
