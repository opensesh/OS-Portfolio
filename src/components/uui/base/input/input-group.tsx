...
import type { TextFieldProps } from "@/components/uui/base/input/input";
import { TextField } from "@/components/uui/base/input/input";
...
export const InputPrefix = ({ children, ...props }: InputPrefixProps) => (
    <span
        ...
        className={cx(
            ...
            "in-data-input-wrapper:in-data-leading:-mr-px in-data-input-wrapper:in-data-leading:rounded-l-none",
            "in-data-input-wrapper:in-data-trailing:-ml-px in-data-input-wrapper:in-data-trailing:rounded-r-none",
            // Default size styles
            "px-3 py-2 text-md",
            // Small size styles
            ...
            {({ isDisabled, isInvalid, isRequired }) => (
                <>
                    ...
                    <div
                        ...
                        className={cx(
                            "group relative flex h-max w-full flex-row justify-center rounded-none bg-primary transition-all duration-100 ease-linear",
