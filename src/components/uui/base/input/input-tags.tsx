...
import { Tag, TagGroup, TagList } from "@/components/uui/base/tags/tags";
        ...
        <div className={cx("flex flex-col gap-1.5", className)}>
            ...
            <AriaGroup
                ...
                className={({ isFocusWithin, isDisabled, isInvalid }) =>
                    cx(
                        "group/input relative flex w-full items-center rounded-none bg-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset",
