...
import { type CommonProps, SelectContext, type SelectItemType, sizes } from "@/components/uui/base/select/select-shared";
    ...
    return (
        <AriaGroup
            ...
            className={({ isFocusWithin, isDisabled }) =>
                cx(
                    "relative flex w-full items-center gap-2 rounded-none bg-primary shadow-xs ring-1 ring-primary outline-hidden transition-shadow duration-100 ease-linear ring-inset",
