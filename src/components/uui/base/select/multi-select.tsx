            ...
            <div className={cx("flex flex-col gap-1.5", className)}>
                ...
                <AriaDialogTrigger>
                    <AriaButton
                        ...
                        className={(state) =>
                            cx(
                                "relative flex w-full cursor-pointer items-center rounded-none bg-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset",
                    ...
                    <AriaPopover
                        ...
                        className={(state) =>
                            cx(
                                "w-(--trigger-width) origin-(--trigger-anchor-point) overflow-hidden rounded-none bg-primary shadow-lg ring-1 ring-secondary_alt outline-hidden will-change-transform",
                                state.isEntering &&
