...
import type { IconComponentType } from "@/components/uui/base/badges/badge-types";
import { HintText } from "@/components/uui/base/input/hint-text";
import { Label } from "@/components/uui/base/input/label";
import { Popover } from "@/components/uui/base/select/popover";
import { type SelectItemType, sizes } from "@/components/uui/base/select/select-shared";
import { TagCloseX } from "@/components/uui/base/tags/base-components/tag-close-x";
            ...
            {!isSelectionEmpty &&
                tagSelectContext?.selectedItems?.items?.map((value) => (
                    <span
                        key={value.id}
                        className={cx(
                            "flex min-w-0 items-center rounded-none bg-primary ring-1 ring-primary ring-inset",
    ...
    return (
        <AriaGroup
            ...
            className={({ isFocusWithin, isDisabled }) =>
                cx(
                    "relative flex w-full items-center rounded-none bg-primary shadow-xs ring-1 ring-primary outline-hidden transition duration-100 ease-linear ring-inset",
