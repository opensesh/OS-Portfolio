...
const styles = sortCx({
    ...
    dark: {
        ...
        sizes: {
            sm: "size-8 rounded-none before:rounded-[5px]",
            md: "size-10 rounded-none before:rounded-[7px]",
            lg: "size-12 rounded-[10px] before:rounded-[9px]",
            xl: "size-14 rounded-none before:rounded-[11px]",
        },
        colors: {
    ...
    modern: {
        ...
        sizes: {
            ...
            md: "size-10 rounded-none",
            lg: "size-12 rounded-[10px]",
            xl: "size-14 rounded-none",
        },
        colors: {
