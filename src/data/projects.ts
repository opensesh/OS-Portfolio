...
export const projects: Project[] = [
  {
    ...
    images: [
      ...
      { src: "/images/projects/iterra/i8dim26bhvu5qQR9wg3QosYwH30.jpg", alt: "Iterra brand identity — gallery 1", context: "gallery" },
      { src: "/images/projects/iterra/dNN6V4QOZliCydifbZq9mZHgs.jpg", alt: "Iterra brand identity — gallery 2", context: "gallery" },
      { src: "/images/projects/iterra/4iGWtlK9qyEQGR3kn226neLeOx0.jpg", alt: "Iterra brand identity — gallery 3", context: "gallery" },
      { src: "/images/projects/iterra/8Fzr2bWXJ4rfwYVgMyCTaMY1g.jpg", alt: "Iterra brand identity — gallery 4", context: "gallery" },
      { src: "/images/projects/iterra/ik8GE2cFM5uwwOAW7Rm0E0RbOog.jpg", alt: "Iterra brand mockup — impact 1", context: "mockup" },
      { src: "/images/projects/iterra/iKQP3E2D7UXucYJbubSRc3A7I.jpg", alt: "Iterra brand mockup — impact 2", context: "mockup" },
      { src: "/images/projects/iterra/oWXlEebiIBfCcgSM59CKhTMqlsQ.jpg", alt: "Iterra brand mockup — impact 3", context: "mockup" },
    ],
    testimonials: [
      {
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/projects/biltfour/sjrpQHo4w4oBUX8dPQaGDaJkNZg.jpg", alt: "BILTFOUR brand identity — gallery 1", context: "gallery" },
      { src: "/images/projects/biltfour/pYAJf9ADtTSPByh3d3XPiPaIdBw.jpg", alt: "BILTFOUR brand identity — gallery 2", context: "gallery" },
      { src: "/images/projects/biltfour/fQNXA7iFcdLekr5tbHmESnMDE.jpg", alt: "BILTFOUR brand identity — gallery 3", context: "gallery" },
      { src: "/images/projects/biltfour/5TsBjj8W6O6DUV5qMByIYXPrnBs.jpg", alt: "BILTFOUR brand identity — gallery 4", context: "gallery" },
      { src: "/images/projects/biltfour/VWj6qlkvnLdlyTExZDWZiezC104.jpg", alt: "BILTFOUR brand mockup — impact 1", context: "mockup" },
      { src: "/images/projects/biltfour/rPlUBgrbosziZBcZfJfPe8sIHA.jpg", alt: "BILTFOUR brand mockup — impact 2", context: "mockup" },
      { src: "/images/projects/biltfour/WUB4oauOJh26lOozw9rKdgUYRk.jpg", alt: "BILTFOUR brand mockup — impact 3", context: "mockup" },
    ],
    results: [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/projects/google-cloud-next/EQmwXTadQPFruJbbhIOlHp8JcbQ.jpg", alt: "NEXT demo experience — gallery 1", context: "gallery" },
      { src: "/images/projects/google-cloud-next/Zcgxim04ZIbn7CooJkyUahMgtU.jpg", alt: "NEXT demo experience — gallery 2", context: "gallery" },
      { src: "/images/projects/google-cloud-next/vN8eB0jmnZQZzLCzcNTS9wDnCc.jpg", alt: "NEXT demo experience — gallery 3", context: "gallery" },
      { src: "/images/projects/google-cloud-next/Y1GhTfRUj1WegONQQcS7bRybV8I.jpg", alt: "NEXT demo experience — gallery 4", context: "gallery" },
      { src: "/images/projects/google-cloud-next/TVWePxkVuYJ2ynKwvW8na7Gz8.jpg", alt: "NEXT design system — mockup 1", context: "mockup" },
      { src: "/images/projects/google-cloud-next/1PeraZj4rwCBVywk3sEvPzcRvYw.jpg", alt: "NEXT design system — mockup 2", context: "mockup" },
      { src: "/images/projects/google-cloud-next/kdIwpWfuzthCYLWztP0haNTzq0.jpg", alt: "NEXT design system — mockup 3", context: "mockup" },
    ],
    results: [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/projects/google-gemini-infinite-nature/0u9mpn2lZqvhWVHgtmYJo9S2ns.jpg", alt: "Infinite Nature UI — gallery 1", context: "gallery" },
      { src: "/images/projects/google-gemini-infinite-nature/akEhFihTl9pdmzuHDf5W4UluIjA.jpg", alt: "Infinite Nature UI — gallery 2", context: "gallery" },
      { src: "/images/projects/google-gemini-infinite-nature/q2vEiw0M4EtJVP7ncaRiBcgzHc4.jpg", alt: "Infinite Nature UI — gallery 3", context: "gallery" },
      { src: "/images/projects/google-gemini-infinite-nature/69we6OfP9rfNdtqOohJDJYMYcC4.jpg", alt: "Infinite Nature UI — gallery 4", context: "gallery" },
      { src: "/images/projects/google-gemini-infinite-nature/ZWM3jBNXCq5MI740NZoGE0owGx4.jpg", alt: "Infinite Nature generative UI — mockup 1", context: "mockup" },
      { src: "/images/projects/google-gemini-infinite-nature/FhgyvB0QzTK3QC0aY40xLmw4K8.jpg", alt: "Infinite Nature generative UI — mockup 2", context: "mockup" },
      { src: "/images/projects/google-gemini-infinite-nature/fEgHnqjSmKjGa0On2DRyNU9HTo.jpg", alt: "Infinite Nature generative UI — mockup 3", context: "mockup" },
    ],
  },
  {
    id: "universal-audio",
    ...
    images: [
      ...
      { src: "/images/projects/universal-audio/5rY7sMJWPqahP45iscJTiYEOw.jpg", alt: "Universal Audio campaign — gallery 1", context: "gallery" },
      { src: "/images/projects/universal-audio/gTZibYtZgjfGpZ3U3WDAunDmOn4.jpg", alt: "Universal Audio campaign — gallery 2", context: "gallery" },
      { src: "/images/projects/universal-audio/VKLBL93wfWhPj6VObEt1a4HlEA.jpg", alt: "Universal Audio campaign — gallery 3", context: "gallery" },
      { src: "/images/projects/universal-audio/2MalmzAFsqsCILwoPC2A6s6Hs.jpg", alt: "Universal Audio campaign — gallery 4", context: "gallery" },
      { src: "/images/projects/universal-audio/UGUpj8bdCLO6Q9L1oTIFNm1BtI.gif", alt: "Universal Audio animated mockup", context: "mockup" },
      { src: "/images/projects/universal-audio/CJC7mcxaL9DGEYB4HGificxTbA.jpg", alt: "Universal Audio product mockup 2", context: "mockup" },
      { src: "/images/projects/universal-audio/PWbwliRrvDvOr6Iw28xulNrFSc.jpg", alt: "Universal Audio product mockup 3", context: "mockup" },
    ],
    results: [
